<fieldset class="traveller-card" data-traveller-card>
    ...
    <div class="booking-contact-grid">
        ...
        <div>
            ...
            <label
                for="traveller_{{ $index }}_full_name"
            >
                Full name *
            </label>
        ...
        <div>
            ...
            <label
                for="traveller_{{ $index }}_date_of_birth"
            >
                Date of birth *
            </label>
    ...
    <div class="traveller-id-section">

        <div class="traveller-id-section__heading">
        ...
        <div class="booking-contact-grid">
            ...
            <div>
                ...
                <label
                    for="traveller_{{ $index }}_id_proof_type"
                >
                    ID proof type *
                </label>
                ...
                @php
                    $selectedIdType = old(
                        'travellers.'.$index.'.id_proof_type',
                ...
                >
                    ...
                    <option
                        value="passport"
                        @selected($selectedIdType === 'passport')
                    >
                        Passport
                    </option>
                    ...
                    <option
                        ...
                        @selected($selectedIdType === 'driving_license')
                    >
                        Driving Licence
                    </option>
                    ...
                    <option
                        value="voter_id"
                        @selected($selectedIdType === 'voter_id')
                    >
                        Voter ID
                    </option>
                    ...
                    <option
                        value="pan_card"
                        @selected($selectedIdType === 'pan_card')
                    >
                        PAN Card
                    </option>
            ...
            <div>
                ...
                <label
                    for="traveller_{{ $index }}_id_proof_number"
                >
                    ID proof number *
                </label>
                ...
                <input
                    ...
                    value="{{ old(
                        'travellers.'.$index.'.id_proof_number',
            ...
            <div>
                ...
                <label
                    for="traveller_{{ $index }}_id_proof_document"
                >
                    Upload ID proof *
                </label>
