...
<title>Bad request | {{ config('travels.brand.name', 'Travels') }}</title>
<style>
...
<p class="error-message">We couldn't process that request. Please check the information and try again.</p>
