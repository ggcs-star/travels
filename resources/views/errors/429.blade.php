...
<title>Too many requests | {{ config('travels.brand.name', 'Travels') }}</title>
<style>
...
<p class="error-message">You've made too many requests in a short time. Please wait a moment and try again.</p>
