...
<title>Request conflict | {{ config('travels.brand.name', 'Travels') }}</title>
<style>
...
<h1 class="error-title">Request conflict</h1>
<p class="error-message">We couldn't complete the request because it conflicts with the current state.</p>
