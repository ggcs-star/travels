...
<title>Temporarily unavailable | {{ config('travels.brand.name', 'Travels') }}</title>
<style>
...
<p class="error-message">We're performing maintenance or an update. Please try again shortly.</p>
