...
<title>Something went wrong | {{ config('travels.brand.name', 'Travels') }}</title>
<style>
...
<p class="error-message">We're sorry, but something unexpected happened. Please try again later.</p>
