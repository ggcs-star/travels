...
<title>Unable to process | {{ config('travels.brand.name', 'Travels') }}</title>
<style>
...
<h1 class="error-title">Unable to process</h1>
<p class="error-message">Some information could not be processed. Please check your details and try again.</p>
