...
<title>Page expired | {{ config('travels.brand.name', 'Travels') }}</title>
<style>
...
<p class="error-message">Your session or form has expired. Please refresh the page and try again.</p>
