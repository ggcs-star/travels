...
<title>Service unavailable | {{ config('travels.brand.name', 'Travels') }}</title>
<style>
...
<p class="error-message">The service is temporarily unavailable. Please try again shortly.</p>
