...
<title>Page not found | {{ config('travels.brand.name', 'Travels') }}</title>
<style>
...
<p class="error-message">The page you're looking for may have moved, changed, or no longer exists.</p>
